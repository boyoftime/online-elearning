...
## 📥 Download the Apps (v1.1)

| App | For | What it opens | Download |
|---|---|---|---|
| 🎓 **E-learning** | Students | Student portal login | [⬇ E-learning-1.1-release.apk](https://github.com/boyoftime/online-elearning/releases/latest/download/E-learning-1.1-release.apk) |
| 👩‍🏫 **OnlineTutors** | Tutors / Teachers | Tutor portal login | [⬇ OnlineTutors-1.1-release.apk](https://github.com/boyoftime/online-elearning/releases/latest/download/OnlineTutors-1.1-release.apk) |
...
├── E-learning-1.1-release.apk      ← student app (also in Releases)
└── OnlineTutors-1.1-release.apk    ← tutor app (also in Releases)
```
